...
translation-extract:
    @just pybabel " \
        extract \
            --omit-header \
            --sort-by-file \
            --output 'src/whiteprints_template_context/locale/base.pot' \
            src \
    "
...
translation-init locale:
    @just pybabel " \
        init \
            --input-file 'src/whiteprints_template_context/locale/base.pot' \
            --output-dir 'src/whiteprints_template_context/locale' \
            --locale='{{ locale }}' \
    "
