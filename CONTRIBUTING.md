...
To report identified bugs, please fill a.[GitHub bug report issue](https://github.com/whiteprints/whiteprints-template-context/issues/new?template=bug_report.yml).
...
To request features, please [open a discussion](https://github.com/whiteprints/whiteprints-template-context/discussions/categories/ideas)

Once the enhancement has been discussed, fill a [GitHub feature issue](https://github.com/whiteprints/whiteprints-template-context/issues/new?template=feature_request.yml).
...
Your contribution needs to meet the following guidelines for acceptance:
  ...
  - Include unit tests; this project maintains [100% code coverage](https://codecov.io/gh/whiteprints/whiteprints-template-context).
...
[Pull Request]: https://github.com/whiteprints/whiteprints-template-context/pulls
[issue]: https://github.com/whiteprints/whiteprints-template-context/issues
